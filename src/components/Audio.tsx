...
// import survey from 'src/assets/station.mp3'
// import synth from 'src/assets/synth.mp3'

type Track = 'home' | 'boarding' | 'survey' | 'result'
...
export function AudioProvider({ children }: any) {
  ...
  return (
    <AudioCtx.Provider value={{ play, stop, enabled, setEnabled }}>
      {children}
    </AudioCtx.Provider>
  )
}
